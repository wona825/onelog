              ...
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <p><br />안녕하세요. 저는 머물러 있지 않고 꾸준히 성장하고자 하는 백엔드 개발자 차지원입니다 🙂
                    ...
                    <br />더 나은 비즈니스에 바탕이 되는 더 좋은 코드와 구현 방식을 고려해보며 계속해서 고민하고, 서비스를 만드는 사람으로서 서비스에 애정을 가지고 개발합니다.
                    <br />개발의 목표 달성은 서비스 구축에서 그치는 것이 아닌 사용자가 목적에 알맞고 편리하게 서비스를 사용함으로써 달성된다고 생각합니다.</p>
                </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
